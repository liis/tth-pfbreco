...
if len(options.inputFiles) == 0:
    options.inputFiles = ["/store/data/Run2012A/MinimumBias/RECO/PromptReco-v1/000/190/678/020F3F32-F982-E111-9436-003048F118AA.root"]
...
process.selectedPatElectrons.cut = "pt>10 && abs(eta)<3.0"
...
process.makePatPhotons = cms.Sequence(
    # object production
    patPhotons
)
